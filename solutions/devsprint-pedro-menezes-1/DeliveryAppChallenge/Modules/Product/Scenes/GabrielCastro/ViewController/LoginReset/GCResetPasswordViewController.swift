...
class GCResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = GCContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = GCCreateAccountViewController()
...
extension GCResetPasswordViewController {
