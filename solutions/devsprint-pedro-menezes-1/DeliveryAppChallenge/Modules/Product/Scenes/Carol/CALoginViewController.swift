...
class CALoginViewController: UIViewController {
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "CAUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "CAResetPasswordViewController") as! CAResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = CACreateAccountViewController()
