...
class PTCreateAccountViewController: UIViewController {
...
// MARK: - Alamofire
extension PTCreateAccountViewController {
...
extension PTCreateAccountViewController: KeyboardAppearenceDelegate {
