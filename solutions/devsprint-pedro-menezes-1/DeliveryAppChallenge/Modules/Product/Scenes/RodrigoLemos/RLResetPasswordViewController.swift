...
class RLResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = RLContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = RLCreateAccountViewController()
...
extension RLResetPasswordViewController {
