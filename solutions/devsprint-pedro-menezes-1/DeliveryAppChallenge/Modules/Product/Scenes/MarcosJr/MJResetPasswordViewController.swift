...
class MJResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = MJContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = MJCreateAccountViewController()
...
extension MJResetPasswordViewController {
