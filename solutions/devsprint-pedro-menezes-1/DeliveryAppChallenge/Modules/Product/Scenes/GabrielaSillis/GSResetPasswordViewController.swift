...
class GSResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = GSContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = GSCreateAccountViewController()
...
extension GSResetPasswordViewController {
