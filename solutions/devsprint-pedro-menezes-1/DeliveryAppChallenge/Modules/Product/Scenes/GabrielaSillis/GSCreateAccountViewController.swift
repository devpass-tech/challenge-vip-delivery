...
class GSCreateAccountViewController: UIViewController {
...
// MARK: - Alamofire
extension GSCreateAccountViewController {
...
extension GSCreateAccountViewController: KeyboardAppearenceDelegate {
