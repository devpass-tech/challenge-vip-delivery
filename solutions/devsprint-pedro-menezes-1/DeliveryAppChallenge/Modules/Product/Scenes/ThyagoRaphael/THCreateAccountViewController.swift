...
class THCreateAccountViewController: UIViewController {
...
// MARK: - Alamofire
extension THCreateAccountViewController {
...
extension THCreateAccountViewController: KeyboardAppearenceDelegate {
