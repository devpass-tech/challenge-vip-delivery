...
class THLoginViewController: UIViewController {
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "THUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "THResetPasswordViewController") as! THResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = THCreateAccountViewController()
...
extension THLoginViewController {
