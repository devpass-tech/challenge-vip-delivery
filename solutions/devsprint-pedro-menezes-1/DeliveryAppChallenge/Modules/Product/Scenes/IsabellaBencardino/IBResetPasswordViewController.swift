...
class IBResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = IBContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = IBCreateAccountViewController()
...
extension IBResetPasswordViewController {
