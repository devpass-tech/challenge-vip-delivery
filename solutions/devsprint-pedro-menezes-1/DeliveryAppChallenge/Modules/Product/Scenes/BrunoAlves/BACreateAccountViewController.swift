...
class BACreateAccountViewController: UIViewController {
...
// MARK: - Alamofire
extension BACreateAccountViewController {
...
extension BACreateAccountViewController: KeyboardAppearenceDelegate {
