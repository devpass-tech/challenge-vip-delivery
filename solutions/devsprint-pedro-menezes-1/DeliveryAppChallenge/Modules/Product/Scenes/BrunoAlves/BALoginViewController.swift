...
class BALoginViewController: UIViewController {
    ...
    @IBAction func resetPasswordButton(_ sender: Any) {
        let storyboard = UIStoryboard(name: "BAUser", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "BAResetPasswordViewController") as! BAResetPasswordViewController
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let controller = BACreateAccountViewController()
