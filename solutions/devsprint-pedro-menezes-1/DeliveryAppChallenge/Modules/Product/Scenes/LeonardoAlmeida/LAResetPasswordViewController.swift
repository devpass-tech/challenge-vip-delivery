...
class LAResetPasswordViewController: UIViewController {
    ...
    @IBAction func helpButton(_ sender: Any) {
        let vc = LAContactUsViewController()
    ...
    @IBAction func createAccountButton(_ sender: Any) {
        let newVc = LACreateAccountViewController()
...
extension LAResetPasswordViewController {
